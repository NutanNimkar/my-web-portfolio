          ...
          {workExperience.map((card, index) => (
            <div key={card.id} className="relative pl-16">
              ...
              <motion.div
                ...
                className="cursor-pointer rounded-2xl border border-gray-700 hover:border-purple-500 bg-gradient-to-br from-gray-900 to-[#04071d] transition-colors duration-300 overflow-hidden"
              >
                ...
                <AnimatePresence>
                  {activeId === card.id && (
                    ...
                    >
                      <div className="px-5 pb-5 border-t border-gray-700/60 pt-4 flex flex-col gap-3">
